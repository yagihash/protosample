...
func (x *MyMessage) GetFoo() string {
	if x != nil {
		return x.Foo
	}
	return ""
...
type MyInternalMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	InFoo string `protobuf:"bytes,1,opt,name=inFoo,proto3" json:"inFoo,omitempty"`
	InBar string `protobuf:"bytes,2,opt,name=inBar,proto3" json:"inBar,omitempty"`
}

func (x *MyInternalMessage) Reset() {
	*x = MyInternalMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *MyInternalMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MyInternalMessage) ProtoMessage() {}

func (x *MyInternalMessage) ProtoReflect() protoreflect.Message {
	mi := &file_sample_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MyInternalMessage.ProtoReflect.Descriptor instead.
func (*MyInternalMessage) Descriptor() ([]byte, []int) {
	return file_sample_proto_rawDescGZIP(), []int{1}
}

func (x *MyInternalMessage) GetInFoo() string {
	if x != nil {
		return x.InFoo
	}
	return ""
...
func (x *MyInternalMessage) GetInBar() string {
	if x != nil {
		return x.InBar
	}
	return ""
...
var file_sample_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x22, 0x2f, 0x0a, 0x09, 0x4d, 0x79, 0x4d, 0x65, 0x73, 0x73,
	...
	0x28, 0x09, 0x52, 0x03, 0x62, 0x61, 0x72, 0x22, 0x3f, 0x0a, 0x11, 0x4d, 0x79, 0x49, 0x6e, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05,
	0x69, 0x6e, 0x46, 0x6f, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x69, 0x6e, 0x46,
	0x6f, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x42, 0x61, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x69, 0x6e, 0x42, 0x61, 0x72, 0x42, 0x21, 0x5a, 0x1f, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x79, 0x61, 0x67, 0x69, 0x68, 0x61, 0x73, 0x68, 0x2f,
...
var file_sample_proto_goTypes = []interface{}{
	(*MyMessage)(nil),         // 0: sample.MyMessage
	(*MyInternalMessage)(nil), // 1: sample.MyInternalMessage
}
...
func file_sample_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sample_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MyInternalMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
